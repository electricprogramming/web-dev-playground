...
export default function _eval(code) {
  const ogLog = console.log, ogErr = console.error, ogWarn = console.warn, ogInfo = console.info;
  ...
  console.log = ogLog; console.error = ogErr; console.warn = ogWarn; console.info = ogInfo;
  return res;
}